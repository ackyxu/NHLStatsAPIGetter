...
class Boxscore:
    def __init__(self, dictBS: dict, gameID: int) -> None:
        ...
        self.team_away_roster = GameRoster(dictBS["teams"]["away"]["players"],"RI"+str(gameID)+"a",gameID)
        self.team_home_id = dictBS["teams"]["home"]["team"]["id"]
        self.team_home_roster = GameRoster(dictBS["teams"]["home"]["players"],"RI"+str(gameID)+"h",gameID)